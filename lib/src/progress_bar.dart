  ...
  const ProgressBar(
      {super.key,
       ...
       this.imageFile,
        @Deprecated('Use size instead')
       this.progressHeight,
        @Deprecated('Use size instead. We have replace with ')
      this.progressWidth,
      });
       ...
       children: [
         ...
         SizedBox(
           ...
           child: CircularProgressIndicator(
             ...
             valueColor: AlwaysStoppedAnimation(progressColor??Theme.of(context).colorScheme.primary),
